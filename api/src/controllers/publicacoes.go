...
// CriarPublicacao adiciona publicacao no banco de dados
func CriarPublicacao(w http.ResponseWriter, r *http.Request) {
	//Extrair as informações passadas
...
// AtualizarPublicacao altera dados da publicação
...
// DeletarPublicacao exclui dados de uma publicação
func DeletarPublicacao(w http.ResponseWriter, r *http.Request) {
	...
	// Aqui verifico se o autor que ta salvo é o mesmo que ta fazendo a publicação
	if publicacaoSalvaNoBanco.AutorID != usuarioID {
