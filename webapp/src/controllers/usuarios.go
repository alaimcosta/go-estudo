...
// CriarUsuario chama a API p/ cadastrar um usuário no banco de dados
func CriarUsuario(w http.ResponseWriter, r *http.Request) {
	//pega o corpo da requisição para acessarmos os campos
	r.ParseForm()

	//montar um json dos campos
...
func AtualizarSenha(w http.ResponseWriter, r *http.Request) {
	...
	//criando a url de acesso da API, como está configurada
