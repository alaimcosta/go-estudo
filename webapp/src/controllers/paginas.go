...
func CarregarTelaDeLogin(w http.ResponseWriter, r *http.Request) {
	//primeiramento verifico se usuário já está autenticado e tem um token
...
func CarregarPaginaPrincipal(w http.ResponseWriter, r *http.Request) {
	...
	var publicacoes []modelos.Publicacao //passando as publicação para o tamplates para serem mostrados na Tela
...
// CarregarPaginaDeUsuarios carrega a página que atendem o filtro passado
...
func CarregarPaginaDeEdicaoDeUsuario(w http.ResponseWriter, r *http.Request) {
	...
	utils.ExecutarTemplate(w, "editar-usuario.html", usuario) // arquivo que será chamado
}
